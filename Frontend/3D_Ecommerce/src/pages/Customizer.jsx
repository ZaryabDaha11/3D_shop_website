...
import Modal from "../components/placeOrderComponents/Modal";
...
const Customizer = () => {
  ...
  const handleSubmit = async (type) => {
    ...
    //call the api to generate the ai image
    try {
    } catch (error) {
      alert(error);
    } finally {
  ...
  return (
    <>
      {isModalActive ? (
        <Modal isVisible={isModalActive } setIsVisible={() => setIsModalActive(!isModalActive)} />
      ) : (
        <AnimatePresence>
          {!snap.intro && (
            <>
